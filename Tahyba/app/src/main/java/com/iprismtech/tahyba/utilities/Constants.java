...
public class Constants {
    ...
    public static final String BASE_URL = "http://iprismconstructions.com/tahybadone/app/";


    //http://iprismconstructions.com/alertnikki/storage/security/testimonial-1.jpg

    public static final String BASE_IMAGE_URL = "http://iprismconstructions.com/tahybadone/";
